...
const Home = ({ navigation }) => {
    ...
    const toggleBookmarked = async (e) => {
      ...
      if (!bookmarked) {
        ...
        if (e.target.id === "1") {
          curUser ? curUser.bookmarked.push("1") : "" ;
      ...
      >
        ...
        <Box style={{ height: 200, alignItems: "center", marginTop: 60 }}>
          <TouchableOpacity onPress={() => navigation.navigate("IndoorOutdoor")}>
            <Image
              source={require("../assets/plantSuggestions.png")}
        ...
        <View style={{ height: 300 }}>
          ...
          >
            ...
            >
              <Card.Image
                source={require("../assets/cardImage.svg")}
                style={{
                  width: 286,
                  height: 196,
              ...
              >
                ...
                >
                  Gardening 101: A Beginner’s Guide To...
                </Card.Title>
            ...
            >
                ...
                <Svg
                  width="25"
                  onPress={(e) => toggleBookmarked(e)}
                  height="45"
                  viewBox="0 10 55 45"
                  fill={bookmarked ? "#827344" : "none"}
                  xmlns="http://www.w3.org/2000/svg"
                  id = "1"
                >
                  <Path
                    d="M1.51322 7.50442C1.51322 4.7175 2.36616 2 7.57305 2H48.1322C50.7654 2 53.3391 2.61491 53.3044 7.06308C53.2696 11.5112 53.3044 66.2777 53.3044 67.8646C53.3044 70.6714 52.1688 74.2567 47.2495 70.1259C42.3302 65.9951 30.771 55.1598 29.6502 54.1184C28.5295 53.0771 27.3146 52.4473 25.2963 54.1829C23.278 55.9185 7.69702 69.6945 7.69702 69.6945C7.69702 69.6945 1.50331 75.1493 1.51322 68.306C1.48347 63.6049 1.51322 10.2913 1.51322 7.50442Z"
                    stroke="#827344"
                    strokeWidth="3"
                    strokeMiterlimit="10"
                  />
  ...
  const HomeScreen = ({ navigation }) => {
    return (
      <Stack.Navigator initialRouteName="PlantsSuggestion">
        ...
        <Stack.Screen
          name="NaturalLightDirection"
          component={NaturalLightDirection}
        />
