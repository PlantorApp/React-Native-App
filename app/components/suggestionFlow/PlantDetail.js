...
const PlantDetail = ({ navigation }) => {
  ...
  let min, minDuration, mod, modDuration, max, maxDuration, low, lowIntensity, med, medIntensity, high, highIntensity, January, February, March, April, May, June, July, August, September, October, November, December;
  ...
  return (
    <ScrollView>
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start', backgroundColor: '#FFFFFF', paddingTop: 60, paddingBottom: 28}}>
        ...
        <VStack style={{marginTop: 28}}>
          ...
          <HStack style={{marginTop: 8}}>
            <Box style={{flex: 1, height: 31, justifyContent: 'center', backgroundColor: low ? "#7D9867" : '#E3DECE', borderTopLeftRadius: 38.25, borderBottomLeftRadius: 38.25}}>
              <Text style={{textAlign: 'center', color: '#ffffff'}}>{lowIntensity}</Text>
            </Box>
            <Box style={{flex: 1, height: 31, justifyContent: 'center', backgroundColor: med ? "#7D9867" : '#E3DECE', marginLeft: 1}}>
              <Text style={{textAlign: 'center', color: '#ffffff'}}>{medIntensity}</Text>
            </Box>
            <Box style={{flex: 1, height: 31, justifyContent: 'center', backgroundColor: high ? "#7D9867" : '#E3DECE', marginLeft: 1, borderBottomRightRadius: 38.25, borderTopRightRadius: 38.25}}>
              <Text style={{textAlign: 'center', color: '#ffffff'}}>{highIntensity}</Text>
            </Box>
          </HStack>
        </VStack>
        <VStack style={{marginTop: 28}}>
          ...
          <HStack style={{marginTop: 8}}>
            <Box style={{flex: 1, height: 31, justifyContent: 'center', backgroundColor: '#E3DECE', borderTopLeftRadius: 38.25, borderBottomLeftRadius: 38.25, borderBottomRightRadius: 38.25, borderTopRightRadius: 38.25}}>
              <Box style={{height: 31, marginLeft: TemperatureMinimum * 9, backgroundColor: '#7D9867', justifyContent: 'center', width: '50%', borderTopLeftRadius: 38.25, borderBottomLeftRadius: 38.25, borderBottomRightRadius: 38.25, borderTopRightRadius: 38.25}}>
